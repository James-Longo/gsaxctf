        ...
        setTimeout(async () => {
            try {
                ...
                const optimizeForGender_UNUSED = async (gender, progressStart, progressRange) => {
                    ...
                    const genderTargetPool = genderTeamPools[targetTeam] || {};
                    const genderOpponentPools = { ...genderTeamPools };
                    delete genderOpponentPools[targetTeam];
                    ...
                    const evaluateLocal = (indices) => {
                        ...
                        return { avg: res.reduce((s, r) => s + (r[targetTeam] || 0), 0) / scenarios.length, entries: selected, scenarios: scenarios }; // return scenarios for stats
                    };
                ...
                console.error("Long sim failed:", err);
